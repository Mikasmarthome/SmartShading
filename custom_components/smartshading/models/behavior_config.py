...
class BehaviorConfig:
    ...
    # Protection-category (Tier 4 Absence/Heat/Glare) decisions may still be
    # dispatched. Both default to False — legacy behavior (an active override
    # blocks every non-Safety automatic action, unchanged since before T7).
